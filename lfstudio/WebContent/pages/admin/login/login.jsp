			...
			<form:form action="login.shtml" method="post" modelAttribute="admin">
				...
				<div class="form-group">
					<div class="form-input">
						<i class="fa fa-user"></i><form:input path="adminuser"  placeholder="管理员账号" required="required" />
					</div>
				</div>
				<div class="form-group">
					<div class="form-input">
						<i class="fa fa-eye-slash"></i><form:password path="adminpass" placeholder="管理员密码" required="required" />
					</div>
				</div>
				<div class="form-group verification">
					<input class="" type="text" required="required" name="Verification-Code" placeholder="请输入验证码…" />&nbsp;&nbsp;<img alt="验证码" src="/lfstudio/admin/VerificationCode.shtml">
				</div>
				<label class="error">${loginfail }</label><br />
