		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					 <button type="button" class="btn btn-default btn-block btn-success" data-toggle="modal" data-target="#myModal">新增宿舍楼</button>
				</div>
			</div>
			<div class="row clearfix dormitory">
				<c:forEach items="${dormitorylist }" var="dormitory">
					<div class="col-md-3 column dormitory-outbox">
						<div class="dormitory-box"><a href="<%= request.getContextPath() %>/admin/dormitoryroom.shtml?pid=${dormitory.id }"><h3>${dormitory.name }</h3></a><i class="fa fa-close remove" domitoryname="${dormitory.name }" domitoryid="${dormitory.id }"></i></div>
					</div>
				</c:forEach>
			</div>
		</div>
		    ...
		    <div class="modal-dialog">
		      <div class="modal-content">
		        ...
		        <div class="modal-header">
		          <h4 class="modal-title">请输入新增宿舍楼名字！<span>(格式为：第1栋宿舍楼)</span></h4>
