	...
	<header>
		<div>
			<ul class="breadcrumb">
				...
				<li class="active">${student.studentid }</li>
			</ul>
		</div>
	</header>
	<section>
				...
				<div class="col-md-8 column">
					<div class="row clearfix">
						<div class="col-md-6 column">
							...
							<div class="form-group">
								<label>学院：</label>
								<input class="form-control" readonly="readonly" value="${college }" />
							</div>
							<div class="form-group">
								<label>专业：</label>
								<input class="form-control" readonly="readonly" value="${major }" />
							</div>
							<div class="form-group">
								<label>班别：</label>
								<input class="form-control" readonly="readonly" value="${majorclass }" />
							</div>
							<div class="form-group">
								<label>宿舍楼：</label>
								<input class="form-control" readonly="readonly" value="${dormitorys.name }" />
							</div>
							<div class="form-group">
								<label>宿舍号：</label>
								<input class="form-control" readonly="readonly" value="${dormitoryrooms.name }" />
							</div>
						</div>
						<div class="col-md-6 column">
							<div class="form-group">
