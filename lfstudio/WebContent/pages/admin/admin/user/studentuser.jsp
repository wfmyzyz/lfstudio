...
<body>
	...
	<header>
	    ...
	    <div class="search">
			<input id="searchtext" type="text" placeholder="按学号搜索…" /><i id="searchbtn" class="fa fa-search"></i>
		</div>
	</header>
	<section>
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<a href="<%= request.getContextPath()+"/admin/actionstudentuser.shtml?act=insert" %>" class="btn btn-default btn-block btn-success addadminbtn">新增学生用户</a>
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>${user.user }</td>
								<td>${user.pass }</td> 
								<td><a href="<%= request.getContextPath() %>/admin/actionstudentuser.shtml?act=update&id=${user.id }">修改</a>&nbsp;|&nbsp;<a class="delectadminbtn" userpid="${user.user }"  userid="${user.id }" href="javascript:void(0)">删除</a></td>
								<td><a href="<%= request.getContextPath() %>/admin/studentmessage/${user.user}.shtml">新增/修改</a></td>
							</tr>
							</c:forEach>
						</tbody>
					</table>
