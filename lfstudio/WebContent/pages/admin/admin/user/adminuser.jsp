...
<body>
	...
	<header>
		<div>
			<ul class="breadcrumb">
				<li><a href="<%= request.getContextPath()%>/admin/adminuser.shtml">管理员列表</a></li>
			</ul>
		</div>
	</header>
	<section>
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<a
						href="<%= request.getContextPath()+"/admin/actionadminuser.shtml?act=insert" %>"
						class="btn btn-default btn-block btn-success addadminbtn">新增管理员</a>
						...
						<tbody>
							<c:forEach items="${userlist }" var="user">
								<tr>
									...
									<td><a
										href="<%= request.getContextPath() %>/admin/actionadminuser.shtml?act=update&id=${user.id }">修改</a>&nbsp;|&nbsp;<a
										class="delectadminbtn" adminid="${user.id }"
