...
<body>
	<div class="pagination-centered">
		<ul class="pagination">
			<li><span>共${pages }页</span>&nbsp;<span>-</span>&nbsp;<span>${countnum }条</span></li>
			<!-- 页面上转 -->
			<c:if test="${nowpage == 1 }">
				<li class="arrow unavailable"><a
					href="${url}&pageid=${nowpage-1  }">«</a></li>
			</c:if>
			<c:if test="${nowpage != 1 }">
			...
			<li><span>跳转到</span></li>
			<li><input id="jumppid"
				style="width: 50px; height: 25px; padding: 0px 0px 0px 5px; margin-top: 5px;"
				type="number" max="${pages }" min="1" /></li>
			<li><span>页</span></li>
	...
	function jump() {
		...
		window.location.href="${url }&pageid="+parseInt($("#jumppid").val());
