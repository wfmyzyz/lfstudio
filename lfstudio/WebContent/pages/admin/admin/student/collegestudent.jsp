...
<body>
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					...
					<ul>
						...
						<li><a href="#college${colleges.id }"><c:out value="${colleges.name }"></c:out> </a></li>
						</c:forEach>
					</ul>
					</div>
				</div>
											...
											<div class="col-md-12 column">
												<c:forEach items="${classes }" var="class">
													<c:if test="${majors.id == class.pid }">
														<a href="<%= request.getContextPath()+"/admin/student/college/class.shtml?" %>
	...
	<footer>
		<div class="back"><i class="fa fa-arrow-up"></i></div>
	</footer>
	<script type="text/javascript">
	(function() {
